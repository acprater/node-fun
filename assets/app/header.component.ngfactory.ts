...
class _View_HeaderComponent0 extends import1.AppView<import3.HeaderComponent> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this.renderer.setElementAttribute(this._el_11,'class','glyphicon glyphicon-inbox');
    this._text_12 = this.renderer.createText(this._el_9,' Messenger\n                        ',(null as any));
    ...
    this._RouterLinkActive_15_3 = new import10.RouterLinkActive(this.parentInjector.get(import13.Router),new import14.ElementRef(this._el_15),this.renderer);
    ...
    this._RouterLinkWithHref_17_3 = new import12.RouterLinkWithHref(this.parentInjector.get(import13.Router),this.parentInjector.get(import15.ActivatedRoute),this.parentInjector.get(import16.LocationStrategy));
    this._text_18 = this.renderer.createText(this._el_17,'\n                            ',(null as any));
    this._el_19 = this.renderer.createElement(this._el_17,'span',(null as any));
    this.renderer.setElementAttribute(this._el_19,'class','glyphicon glyphicon-user');
    this._text_20 = this.renderer.createText(this._el_17,' Authentication\n                        ',(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import12.RouterLinkWithHref) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 12)))) { return this._RouterLinkWithHref_9_3; }
    if (((token === import10.RouterLinkActive) && ((7 <= requestNodeIndex) && (requestNodeIndex <= 13)))) { return this._RouterLinkActive_7_3; }
    if (((token === import12.RouterLinkWithHref) && ((17 <= requestNodeIndex) && (requestNodeIndex <= 20)))) { return this._RouterLinkWithHref_17_3; }
    if (((token === import10.RouterLinkActive) && ((15 <= requestNodeIndex) && (requestNodeIndex <= 21)))) { return this._RouterLinkActive_15_3; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    changes = (null as any);
    const currVal_6:any = this._arr_1('/auth/logout');
    if (import4.checkBinding(throwOnChange,this._expr_6,currVal_6)) {
      this._RouterLinkWithHref_17_3.routerLink = currVal_6;
      if ((changes === (null as any))) { (changes = {}); }
    ...
    if (!throwOnChange) {
      ...
      if (this._query_RouterLinkWithHref_7_1.dirty) {
        this._query_RouterLinkWithHref_7_1.reset([this._RouterLinkWithHref_9_3]);
      ...
      if (this._query_RouterLinkWithHref_15_1.dirty) {
        this._query_RouterLinkWithHref_15_1.reset([this._RouterLinkWithHref_17_3]);
    ...
    const currVal_7:any = this._RouterLinkWithHref_17_3.href;
    if (import4.checkBinding(throwOnChange,this._expr_7,currVal_7)) {
      this.renderer.setElementProperty(this._el_17,'href',this.viewUtils.sanitizer.sanitize(import17.SecurityContext.URL,currVal_7));
...
export function viewFactory_HeaderComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.HeaderComponent> {
  if ((renderType_HeaderComponent === (null as any))) { (renderType_HeaderComponent = viewUtils.createRenderComponentType('C:/dev/node-fun/assets/app/header.component.ts class HeaderComponent - inline template',0,import8.ViewEncapsulation.None,styles_HeaderComponent,{})); }
