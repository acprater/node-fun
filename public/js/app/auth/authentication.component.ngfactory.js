...
var _View_AuthenticationComponent0 = (function (_super) {
    ...
    _View_AuthenticationComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._el_18 = this.renderer.createElement(this._el_16, 'router-outlet', null);
        this._appEl_18 = new import2.AppElement(18, 16, this, this._el_18);
        this._RouterOutlet_18_5 = new import12.RouterOutlet(this.parentInjector.get(import14.RouterOutletMap), this._appEl_18.vcRef, this.parentInjector.get(import15.ComponentFactoryResolver), null);
...
export function viewFactory_AuthenticationComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_AuthenticationComponent === null)) {
        (renderType_AuthenticationComponent = viewUtils.createRenderComponentType('C:/dev/node-fun/assets/app/auth/authentication.component.ts class AuthenticationComponent - inline template', 0, import9.ViewEncapsulation.None, styles_AuthenticationComponent, {}));
    }
...
var _View_AuthenticationComponent1 = (function (_super) {
    ...
    _View_AuthenticationComponent1.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import18.RouterLinkWithHref) && ((1 <= requestNodeIndex) && (requestNodeIndex <= 2)))) {
            return this._RouterLinkWithHref_1_3;
        }
        if (((token === import16.RouterLinkActive) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 2)))) {
