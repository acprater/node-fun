...
export function viewFactory_MessagesComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_MessagesComponent === null)) {
        (renderType_MessagesComponent = viewUtils.createRenderComponentType('C:/dev/node-fun/assets/app/messages/messages-component.ts class MessagesComponent - inline template', 0, import8.ViewEncapsulation.None, styles_MessagesComponent, {}));
    }
