...
export function viewFactory_MessageComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_MessageComponent === null)) {
        (renderType_MessageComponent = viewUtils.createRenderComponentType('C:/dev/node-fun/assets/app/messages/message.component.html', 0, import9.ViewEncapsulation.Emulated, styles_MessageComponent, {}));
    }
