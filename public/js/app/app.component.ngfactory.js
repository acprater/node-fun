...
export function viewFactory_AppComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_AppComponent === null)) {
        (renderType_AppComponent = viewUtils.createRenderComponentType('C:/dev/node-fun/assets/app/app.component.html', 0, import8.ViewEncapsulation.None, styles_AppComponent, {}));
    }
