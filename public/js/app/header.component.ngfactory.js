...
var _View_HeaderComponent0 = (function (_super) {
    ...
    _View_HeaderComponent0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import12.RouterLinkWithHref) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 12)))) {
            return this._RouterLinkWithHref_9_3;
        }
        if (((token === import10.RouterLinkActive) && ((7 <= requestNodeIndex) && (requestNodeIndex <= 13)))) {
            return this._RouterLinkActive_7_3;
        }
        if (((token === import12.RouterLinkWithHref) && ((17 <= requestNodeIndex) && (requestNodeIndex <= 20)))) {
            return this._RouterLinkWithHref_17_3;
        }
        if (((token === import10.RouterLinkActive) && ((15 <= requestNodeIndex) && (requestNodeIndex <= 21)))) {
    ...
    _View_HeaderComponent0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        changes = null;
        var currVal_6 = this._arr_1('/auth/logout');
        ...
        var currVal_7 = this._RouterLinkWithHref_17_3.href;
    ...
    _View_HeaderComponent0.prototype._handle_click_17_0 = function ($event) {
        this.markPathToRootAsCheckOnce();
...
export function viewFactory_HeaderComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_HeaderComponent === null)) {
        (renderType_HeaderComponent = viewUtils.createRenderComponentType('C:/dev/node-fun/assets/app/header.component.ts class HeaderComponent - inline template', 0, import8.ViewEncapsulation.None, styles_HeaderComponent, {}));
    }
